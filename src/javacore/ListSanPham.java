...
public static ArrayList<Sanpham> getAlldanhsachSp() throws ClassNotFoundException, Exception {
  ...
  ArrayList<Sanpham> arrListgetall = new ArrayList<Sanpham>();
   while(resultSet.next()) {
	   ...
	   arrListgetall.add(new Sanpham(idsp,ten,price,image1,image2,phankhoi,pricegiamgia,status,description,information, comment,phanloai));
...
public  ArrayList<Sanpham> getSanPhamPhanTrang(int index) throws ClassNotFoundException, Exception{
     ...
     ResultSet resultSet = statement.executeQuery();
      while (resultSet.next()) {
   	...
   	arrListgetPhantrang.add(new Sanpham(idsp,ten,price,image1,image2,phankhoi,pricegiamgia,status,description,information, comment,phanloai));
      }
