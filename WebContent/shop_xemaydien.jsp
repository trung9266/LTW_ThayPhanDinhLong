                    ...
                    <div class="col-lg-3 order-2 order-lg-1">
                        <div class="sidebar">
                            ...
                            <div class="electronics mb-40">
                                <h3 class="sidebar-title">Tổng Quan - Về Xe Máy Điện</h3>
                                    ...
                                    <ul>
                                        ...
                                        <li class="has-sub"><a href="#">Phụ Kiện</a>
                                            <ul class="category-sub">
                                                ...
                                                <li><a href="shop_phukiengiare.html.html">Phụ Kiện Đồng Giá Rẻ</a></li>
                                            </ul>
                                            <!-- category submenu end-->
                                        </li>
                                        <li class="has-sub"><a href="#">Dịch Vụ</a>
                                            <ul class="category-sub">
                                                ...
                                                <li><a href="shop.html">Làm Biển Số Theo Tỉnh</a></li>
                                        ...
                                        <li class="has-sub"><a href="#">Tin Tức Khuyến Mãi</a>
                                            <ul class="category-sub">
                                                <li><a href="lambienso.html">Khuyến Mãi Mới Nhất</a></li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" style="height: 179px;" src="img\products\71.jpg" alt="single-product">
                                                        <img class="secondary-img" style="height: 179px;" src="img\products\72.jpg" alt="single-product">
                                                    </a>
                                                ...
                                                <div class="pro-content">
                                                    <div class="pro-info">
                                                        <h4><a href="product.html">Xe Ga 50cc Dibao Gofast 2020</a></h4>
                                                        <p><span class="price">8.000.000Đ</span><del class="prev-price">12.000.000Đ</del></p>
                                                        <div class="label-product l_sale">30<span class="symbol-percent">%</span></div>
                                                    </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" style="height:179px ;" src="img\products\73.jpg" alt="single-product">
                                                         <img class="secondary-img" style="height:179px ;" src="img\products\74.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img"  style="height:179px ;" src="img\products\75.jpg" alt="single-product">
                                                        <img class="secondary-img"  style="height:179px ;"  style="height:179px ;" src="img\products\76.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                                ...
                                                <div class="pro-content">
                                                    <div class="pro-info">
                                                        <h4><a href="product.html">Xe Ga 50cc Vespa Halim 2020 </a></h4>
                                                        <p><span class="price">16.800.000Đ</span><del class="prev-price">21.000.000Đ</del></p>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" src="img\products\79.jpg" alt="single-product">
                                                        <img class="secondary-img" style="height:221px;" src="img\products\80.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                                ...
                                                <div class="pro-content">
                                                    <div class="pro-info">
                                                        <h4><a href="product.html">Xe Ga 50cc Giorno Mono</a></h4>
                                                        <p><span class="price">18.500.000</span> <del class="prev-price">19.700.000Đ</del></p>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" src="img\products\85.jpg" alt="single-product">
                                                        <img class="secondary-img" src="img\products\86.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                                ...
                                                <div class="pro-content">
                                                    <div class="pro-info">
                                                        <h4><a href="product.html">Xe Ga 50cc CREA Hyosung Korea 2020</a></h4>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" src="img\products\87.jpg" alt="single-product">
                                                        <img class="secondary-img" src="img\products\88.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                                ...
                                                <div class="pro-content">
                                                    <div class="pro-info">
                                                        <h4><a href="product.html">Xe Ga 50CC Giorno Smile Ally</a></h4>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img"  style="height:179px;"src="img\products\77.jpg" alt="single-product"> 
                                                         <img class="secondary-img" src="img\products\78.jpg" alt="single-product"> 
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                                ...
                                                <div class="pro-content">
                                                    <div class="pro-info">
                                                        <h4><a href="product.html">Xe Ga 50cc Nioshima Plus 2020
                                                        </a></h4>
                                                        <p><span class="price">20.500.000Đ</span><del class="prev-price">21.000.000Đ</del></p>
                                                        <div class="label-product l_sale">20<span class="symbol-percent">%</span></div>
                                                    </div>
                                                    <div class="pro-actions">
                                                        <div class="actions-primary">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" style="height: 179px;" src="img\products\81.jpg" alt="single-product">
                                                        <img class="secondary-img" src="img\products\82.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                                ...
                                                <div class="pro-content">
                                                    <div class="pro-info">
                                                        <h4><a href="product.html">Xe Máy Tay Ga 50cc Nioshima</a></h4>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img"  style="height: 179px;" src="img\products\83.jpg" alt="single-product">
                                                        <img class="secondary-img" style="height: 179px;" src="img\products\84.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                                ...
                                                <div class="pro-content">
                                                    <div class="pro-info">
                                                        <h4><a href="product.html">Xe Ga 50cc Nioshima S</a></h4>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" style="height: 199px;" src="img\products\89.jpg" alt="single-product">
                                                        <img class="secondary-img" style="height:201px ;" src="img\products\90.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                                ...
                                                <div class="pro-content">
                                                    <div class="pro-info">
                                                        <h4><a href="product.html">Xe Ga Scoopy 50cc Việt Thái</a></h4>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" src="img\products\91.jpg" alt="single-product">
                                                        <img class="secondary-img" src="img\products\92.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                                ...
                                                <div class="pro-content">
                                                    <div class="pro-info">
                                                        <h4><a href="product.html">Xe Ga 50cc Giorno Hyosung Korea</a></h4>
                                                        <p><span class="price">18.530.000Đ</span><del class="prev-price">19.370.000Đ</del></p>
