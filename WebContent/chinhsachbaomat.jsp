            ...
            <div class="container">
                <div class="main-blog">
                    <div class="row" style="display: block;">
                        <h1 style="padding-bottom: 30px; color: #2E3D77; font-weight: bold;">1. Chúng tôi sẽ làm gì với thông tin của bạn?</h1>
                        <p class="text-p">- Thuật ngữ " Thông tin cá nhân " được sử dụng ở đây được định nghĩa là bất kỳ thông tin nào có thể được sử dụng để nhận dạng, liên lạc hoặc xác định vị trí người mà thông tin đó liên quan. Các thông tin cá nhân mà chúng tôi thu thập đều mang tính bảo mật cho cá nhân , và có thể được sửa đổi theo thời gian.</p>
                        <p class="text-p">- Khi bạn đăng ký SmileBike chúng tôi hỏi tên của bạn, tên công ty, địa chỉ email, địa chỉ thanh toán, và thông tin thẻ tín dụng. Nếu bạn đăng ký tài khoản miễn phí thì không cần phải nhập thẻ tín dụng. Tuy nhiên nếu bạn muốn kích hoạt quá trình thanh toán của bạn, bạn cần phải cung cấp thông tin nhân thẻ tín dụng.</p>
                        <p class="text-p">- SmileBike sử dụng thông tin chúng tôi thu thập cho các mục đích chung sau đây: các sản phẩm và các dịch vụ cung cấp, thanh toán, xác định và xác thực, cải thiện dịch vụ , liên hệ, và nghiên cứu.</p>
                        <p class="text-p">- Là một phần của quá trình mua và bán trên SmileBike, bạn sẽ có được địa chỉ email và hoặc địa chỉ vận chuyển của khách hàng. Bằng cách nhập vào Điều khoản người sử dụng của chúng tôi, bạn đã đồng ý rằng, những thông tin liên quan đến người dùng khác mà bạn có được thông qua SmileBike hoặc thông qua một kênh truyền thông liên quan đến SmileBike hoặc do Giao dịch SmileBike tạo điều kiện, SmileBike sẽ cấp cho bạn một giấy phép sử dụng những thông tin đó chỉ trong mục đích sử dụng có liên quan đến SmileBike, mà không phải là những thông điệp thương mại khác. SmileBike không chấp nhận thư rác. Vì vậy, với những hạn chế nêu trên, bạn không được cấp phép để thêm tên của những người đã mua một mặt hàng từ bạn, vào danh sách email của bạn ( email hoặc thư vật lý) mà không cần sự đồng ý của họ.</p>
                        <h1 style="padding-bottom: 30px; color: #2E3D77; font-weight: bold;">2. Sự bảo mật</h1>
                        <p class="text-p">- Bảo mật thông tin cá nhân của bạn là rất quan trọng với chúng tôi. Khi bạn nhập thông tin nhạy cảm, như số thẻ tín dụng vào mẫu đăng ký của chúng tôi, chúng tôi mã hóa việc truyền tải thông tin bằng cách sử dụng công nghệ mã hóa an toàn SSL - Secure Sockets Layer. Không có phương pháp truyền qua Internet, hoặc phương pháp lưu trữ điện tử, là 100% an toàn. Vì vậy, trong khi chúng tôi cố gắng sử dụng phương tiện mã hóa an toàn để bảo vệ thông tin cá nhân của bạn, chúng tôi không thể đảm bảo an ninh tuyệt đối. Nếu bạn có bất kỳ câu hỏi về bảo mật trên trang web của chúng tôi, bạn có thể gửi email cho chúng tôi tại 18130259@st.hcmuaf.edu.vn .</p>
                        <h1 style="padding-bottom: 30px; color: #2E3D77; font-weight: bold;">3. Công bố</h1>
                        <p class="text-p">- SmileBike có thể sử dụng các nhà cung cấp dịch vụ bên thứ ba để cung cấp một số dịch vụ cho bạn và chúng tôi có thể chia sẻ thông tin cá nhân với các nhà cung cấp dịch vụ đó. Chúng tôi yêu cầu bất kỳ công ty mà chúng tôi có thể chia sẻ thông tin cá nhân bảo vệ dữ liệu một cách phù hợp với chính sách này và hạn chế việc sử dụng các thông tin cá nhân như vậy để thực hiện dịch vụ cho SmileBike.</p>
                        <p class="text-p">- SmileBike có thể tiết lộ thông tin cá nhân trong các trường hợp đặc biệt, chẳng hạn như để thực hiện theo lệnh của tòa án yêu cầu chúng tôi làm như vậy hoặc khi hành động của bạn vi phạm Điều khoản Dịch vụ .</p>
                        <p class="text-p">- Chúng tôi không bán hay cung cấp thông tin cá nhân cho các công ty khác để tiếp thị sản phẩm hay dịch vụ của mình .</p>
                        <h1 style="padding-bottom: 30px; color: #2E3D77; font-weight: bold;">4. Lưu trữ dữ liệu khách hàng</h1>
                        <p class="text-p">- SmileBike sở hữu lưu trữ dữ liệu , cơ sở dữ liệu và tất cả các quyền đối với ứng dụng SmileBike. Tuy nhiên chúng tôi không yêu cầu sử dụng các quyền của dữ liệu của bạn. Bạn giữ lại tất cả các quyền đối với dữ liệu của bạn và chúng tôi sẽ không bao giờ liên lạc với khách hàng của bạn trực tiếp, hoặc sử dụng dữ liệu của bạn cho lợi thế kinh doanh của chúng tôi hoặc cạnh tranh với bạn hoặc thị trường để khách hàng của bạn .</p>
                        <h1 style="padding-bottom: 30px; color: #2E3D77; font-weight: bold;">5. Cookies</h1>
                        <p class="text-p">- Cookie là một lượng nhỏ dữ liệu , có thể bao gồm một định danh duy nhất vô danh. Cookie được gửi tới trình duyệt của bạn từ một trang web và được lưu trữ trên ổ đĩa cứng của máy tính. Mỗi máy tính có thể truy cập trang web của chúng tôi được phân công một cookie khác nhau.</p>
                        <h1 style="padding-bottom: 30px; color: #2E3D77; font-weight: bold;">6. Thay đổi chính sách bảo mật</h1>
                        <p class="text-p">- Chúng tôi có quyền thay đổi chính sách bảo mật này bất cứ lúc nào, vì vậy hãy xem xét nó thường xuyên. Nếu chúng tôi có thay đổi quan trọng đối với chính sách này, chúng tôi sẽ thông báo cho bạn đây hoặc bằng một thông báo trên trang chủ của chúng tôi để bạn nhận thức được những gì chúng tôi thu thập thông tin, làm thế nào chúng ta sử dụng nó, và trong hoàn cảnh nào, chúng tôi sẽ tiêt lộ nó, nếu có.</p>
                        <p class="text-p"></p>
                        <p class="text-p"></p>
                        <p class="text-p"></p>
                    </div>
