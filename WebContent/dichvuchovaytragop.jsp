    ...
    <div class="wrapper">
       ...
       <!-- Newsletter Popup Start -->
        ...
        <div class="single-blog ptb-100  ptb-sm-60">
            <div class="container">
                 <h1 style="font-style: 30px;position: relative; left: 300px; top: -50px;" > Sở hữu 1 chiếc xe máy chưa bao giờ dễ dàng đến thế !</h1>
                <div class="row">
                    <!-- Single Blog Sidebar Start -->
                    <div class="col-lg-3 order-2 order-lg-1">
                        <aside>
                            <div class="single-sidebar latest-pro mb-30">
                                <h3 class="sidebar-title">Dịch vụ trả góp xe</h3>
                                <ul class="sidbar-style">
                                    <li><a href="dichvuchovaytragop.html">Trả góp theo quí </a></li>
                                    <li><a href="dichvuchovaytragop.html">Trả góp theo năm</a></li>
                                    <li><a href="dichvuchovaytragop.html">Trả góp theo tháng</a></li>
                                    <li><a href="dichvuchovaytragop.html">Trả góp theo ngày</a></li>
                                </ul>
                            </div>
                            ...
                            <div class="single-sidebar mb-30">
                                 ...
                                 <ul class="sidbar-style">
                                     ...
                                     <li><a href="dichvubaohiem.html">Đăng Kí Bảo Hiểm Xe <abbr title="Really Simple Syndication">RSS</abbr></a></li>
                    ...
                    <div class="col-lg-9 order-1 order-lg-2">
                        <div class="single-sidebar-desc mb-all-40">
                            <div class="sidebar-img">
                                <img src="img\products\184.jpg" alt="single-blog-img">
                            </div>
                            <div class="sidebar-post-content">
                                <h3 class="sidebar-lg-title">Ưu Đãi bất ngờ , Lãi xuất trả góp chỉ từ 0.01% - 0.79%</h3>
                            ...
                            <div class="sidebar-desc mb-50">
                                <p>  
                                    Mua xe máy trả góp Honda có nhiều hình thức dành khách hàng chứng minh được thu nhập hoặc không chứng minh được thu nhập hàng tháng. Lãi suất trả góp dao động từ 0%  - 0.79%/tháng..</p>
                                <blockquote class="mtb-30"> <p>Mua xe Honda trả góp là hình thức mua xe nhưng trả dần vào các tháng theo một kỳ hạn trả góp đã thỏa thuận từ trước. Tùy vào hình thức trả góp bạn chọn mà có thể sẽ phải trả trước một phần hoặc không cần ứng trước tiền mua xe. Ngoài ra phần lãi suất trả góp cũng tùy vào ngân hàng, công ty tài chính quy định từng thời kỳ.

 

                                    Hiện nay bạn có thể mua xe máy Honda trả góp theo hình thức đặt hàng online hoặc đến trực tiếp các đại lý xe máy để mua.</p><span>Giám Đốc</span></blockquote>
                                <p style="font-weight: bold;"> Quy trình mua xe trả góp tại đại lý  .</p>
                                <ul>
                                    <li> <span style="font-weight: bold;" >Bước 1:</span> Chọn đại lý xe để mua và chọn chiếc xe Honda muốn mua</li>
                                    <li><span style="font-weight: bold;" > Bước 2:</span> Thương lượng với bên bán xe để xác định khoản tiền trả trước. Số tiền này có thể dao động từ 20%-70% giá trị chiếc xe</li>
                                    <li><span style="font-weight: bold;" > Bước 3:</span> Chọn công ty tài chính hoặc ngân hàng hỗ trợ cho vay mua xe Honda trả góp. Nhân viên của hãng sẽ tư vấn cho bạn những ngân hàng và công ty tài chính liên kết cho vay trả góp. </li>
                                    <li><span style="font-weight: bold;" > Bước 4:</span> Gặp nhân viên cho vay trả góp để hoàn tất thủ tục mua xe máy Honda trả góp.</li>
                                ...
                                <br>
                                <p style="font-weight: bold;"> Để biết thêm các thông tin thêm như thủ tục giấy tờ cần thiết,lãi xuất trả góp....Vui longg điền thông tin vào dưới đây, nhân viên chúng tôi sẽ gọi điện tư ván cho bạn cảm ơn!</p>
                            </div>
