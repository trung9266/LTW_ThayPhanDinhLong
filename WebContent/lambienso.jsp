    ...
    <div class="wrapper">
       ...
       <!-- Newsletter Popup Start -->
        ...
        <div class="single-blog ptb-100  ptb-sm-60">
            <div class="container">
                 <h1 style="font-style: 30px;position: relative; left: 300px; top: -50px;" >Sở Hữu Các Biển Số Xe Bình Dân - Đến Đẹp Giá Ưu Đãi</h1>
                <div class="row">
                    <!-- Single Blog Sidebar Start -->
                    <div class="col-lg-3 order-2 order-lg-1">
                        <aside>
                            <div class="single-sidebar latest-pro mb-30">
                                <h3 class="sidebar-title">Dịch vụ Làm biển Số Xe</h3>
                            ...
                            <div class="col-img mb-30">
                                <a href="dichvubaohiem.html"><img src="img\products\188.jpg" alt="slider-banner"></a>
                            </div>
                    ...
                    <div class="col-lg-9 order-1 order-lg-2">
                        <div class="single-sidebar-desc mb-all-40">
                            <div class="sidebar-img">
                                <img src="img\products\187.jpg" alt="single-blog-img">
                            </div>
                            <div class="sidebar-post-content">
                                <h3 class="sidebar-lg-title">Dịch vụ làm biển số xe máy ? ( Đăng Kí / Cấp Lại)
                                    
                                </h3>
                                <ul class="post-meta d-sm-inline-flex">
                                    <li><span>Bài đăng bởi</span> An Lưu Văn</li>
                                    <li><span> 12 tháng 11, 2020</span></li>
                                </ul>
                            </div>
                            <div class="sidebar-desc mb-50">
                                <p>Nhận làm biển số xe máy, làm mới biển số xe máy, làm lại biển số xe máy, đổi biển số cũ sang biển số xe máy…. thủ tục đơn giản, thời gian nhanh chóng, chi phí hợp lý
                                <br>
                                ...
                                <blockquote class="mtb-30"> <p> Nhiều người vẫn còn khá băn khoăn khi đăng ký biển số xe điện tại cơ quan nhà nước. Chúng tôi sẽ tư vấn  những gợi ý giúp ích cho bạn để giảm bớt tình trạng lo lắng này:
                                    .

 
                                
                                   </p><span>Xèo Xèo</span></blockquote>
                                <p style="font-weight: bold;"> Các giấy tờ cần thiết để đăng ký biển số xe  .</p>
                                <img src="img/products/189.jpg" style="" alt="ko co j">
                                <br>
                                <p>Trước khi đến các cơ quan nhà nước để đăng ký, bạn cần chuẩn bị một số giấy tờ cần thiết sau:

                                    ;</p>
                                <br>
                                <br>
                                <ul>
                                    <li> <span style="font-weight: bold;" >Bước 1: </span> Những cá nhận, tổ chức cần chuẩn bị đầy đủ hồ sơ cần thiết theo quy định của pháp luật.</li>
                                    <li><span style="font-weight: bold;" > Bước 2: </span> Nộp hồ sơ trực tiếp tại cơ quan đăng ký xe của Công An hoặc Phòng cảnh sát giao thông (nơi cấp biển số xe ban đầu)</li>
                                    <li><span style="font-weight: bold;" >    +</span>  Nộp hồ sơ tại Công an Huyện, Quận, Thị xã, Thành phố thuộc tỉnh </li>
                                    <li><span style="font-weight: bold;" > +</span>+ Thời gian để tiếp nhận hồ sơ: Giờ hành chánh từ thứ 2 đến thứ 6 hàng tuần (chủ nhật và ngày lễ nghỉ).</li>
                                    <li><span style="font-weight: bold;" > Bước 3:</span> Nhận đăng ký, biển số xe mới tại trụ sở cơ quan đăng ký xe.</li>
                                    <li><span style="font-weight: bold;" >    +</span> + Chủ xe giao giấy hẹn, cán bộ trả kết quả kiểm tra và trả đăng ký, biển số xe cho chủ xe..</li>
                                </ul>
                                <br>
