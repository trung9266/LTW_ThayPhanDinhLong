    ...
    <div class="wrapper">
       ...
       <!-- Newsletter Popup Start -->
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="sidebar-img mb-all-30">
                            <img src="img/brand/anturng.jpg" alt="single-blog-img">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="about-desc">
                            <h3 class="mb-10 about-title">Nhóm 48 - Lập Trình Web Thầy Long - ĐH Nông Lâm TP.HCM</h3>
                            <p class="mb-20">Những người thành thạo các kỹ năng lập trình máy tính có thể trở nên nổi tiếng, tuy nhiên sự đánh giá này lại bị giới hạn bởi những phạm vi trong lĩnh vực công nghệ phần mềm. Nhiều trong số những lập trình viên danh tiếng lại được dán mác là tin tặc.</p>
                            <p class="mb-20">Project: Website bán hàng online</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="about-team pt-100 pt-sm-60">
            <div class="container">
               <h3 class="mb-30 about-title">Thành viên</h3>
                <div class="row text-center">
                    <!-- Single Team Start Here -->
                    <div class="col-lg-3 col-md-6 col-sm-6 col-6">
                        <div class="single-team mb-xxs-30">
                            <div class="team-img sidebar-img">
                                <img style="margin-left: auto; margin-right: auto;" src="img/brand/an.jpg" alt="team-image">
                                <div class="team-link">
                                    <ul>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-6">
                        <div class="single-team">
                            <div class="team-img sidebar-img">
                                <img src="img/brand/trung.jpg" alt="team-image">
                                <div class="team-link">
                                    <ul>
                                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                                        <li><a href="#"><i class="fa fa-twitter"></i></a></li>
