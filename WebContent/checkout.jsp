    ...
    <div class="wrapper">
       <!-- Newsletter Popup Start -->
        ...
        <div class="checkout-area pb-100 pt-15 pb-sm-60">
            <div class="container">
             <form action="DonhangUser" method="post">
                <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="country-select clearfix mb-30">
                                        ...
                                        <select class="wide">
                                            ...
                                            <option value="england">Việt Nam</option>
                                            <option value="saab">Việt Nam</option>
                                            <option value="mercedes">Việt Nam</option>
                                            <option value="audi">Việt Nam</option>
                                            <option value="audi2">Việt Nam</option>                      
                                            <option value="audi3">Việt Nam</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <div class="checkout-form-list">
                                        ...
                                        <input type="text" name="diachi" placeholder="Số nhà, tên đường">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="checkout-form-list mtb-30">
                                        <label>Xã, huyện<span class="required">*</span></label>
                                        <input type="text" name="xahuyen" placeholder="Xã, huyện">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="checkout-form-list mb-30">
                                        <label>Tỉnh, thành phố<span class="required">*</span></label>
                                        <input type="text" name="tinhthanhpho" placeholder="Tỉnh, hành phố">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="checkout-form-list mb-30">
                                        ...
                                        <input type="text" name="sodienthoai" placeholder="">
                                    </div>
                                </div>
                            </div>
                        </div>
			                      ...
			                      %>
                                        ...
                                        <tr class="cart_item">
                                            <td class="product-name">
                                                Winner-X Năng Động <span class="product-quantity"> × 1</span>
                                            </td>
                                            <td class="product-total">
                                                <span class="amount">35.000.000Đ</span>
                                            </td>
                                        </tr>
                                    ...
                                    <tfoot>
                                        <tr class="order-total">
                                            ...
                                            <td><span class=" total amount">92.000.000Đ</span>
                                            </td>
                                        </tr>
                                    </tfoot>
                                </table>
                                ...
                                <div id="accordion">
                                    ...
                                    <div class="card">
                                        ...
                                        <div id="collapseTwo" class="collapse" aria-labelledby="headingtwo" data-parent="#accordion">
                                            <div class="card-body">
                                                <p>Thực hiện thanh toán khi đã nhận được hàng.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card">
                                    ...
                                    <div>
                                        <button type="submit" style="padding: 15px; border-radius: 10px; background:#e62e04; color: #fff; border: none;display: block; margin-left: auto; margin-top: 20px;">Thanh toán</button>
                                    </div>
                                </div>
                            </div>
                        </div>
