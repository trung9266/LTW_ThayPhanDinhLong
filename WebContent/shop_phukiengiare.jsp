                    ...
                    <div class="col-lg-3 order-2 order-lg-1">
                        <div class="sidebar">
                            ...
                            <div class="electronics mb-40">
                                <h3 class="sidebar-title">Tổng Quan - Phụ Kiện Giá Rẻ</h3>
                                    ...
                                    <ul>
                                        ...
                                        <li class="has-sub"><a href="#">Phụ Kiện</a>
                                            <ul class="category-sub">
                                                ...
                                                <li><a href="shop.html">Phụ Kiện Đồng Giá Rẻ</a></li>
                                            </ul>
                                            <!-- category submenu end-->
                                        </li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" style="height: 179px;" src="img\products\165.jpg" alt="single-product">
                                                        <img class="secondary-img" style="height: 179px;" src="img\products\166.jpg" alt="single-product">
                                                    </a>
                                                ...
                                                <div class="pro-content">
                                                    <div class="pro-info">
                                                        <h4><a href="product.html">Kính Vario theo xe 2020 mua về đã tháo</a></h4>
                                                        <p><span class="price">180.000Đ</span><del class="prev-price">250.000Đ</del></p>
                                                        <div class="label-product l_sale">30<span class="symbol-percent">%</span></div>
                                                    </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" style="height:179px ;" src="img\products\168.jpg" alt="single-product">
                                                         <img class="secondary-img" style="height:179px;" src="img\products\167.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                                ...
                                                <div class="pro-content">
                                                    <div class="pro-info">
                                                        <h4><a href="product.html">Bán 2 cây cam độ 6.5 và zin wave rss</a></h4>
                                                        <p><span class="price">150.000Đ</span><del class="prev-price">244.000Đ</del></p>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" style="height:179px ;" src="img\products\169.jpg" alt="single-product">
                                                        <img class="secondary-img" style="height:179px ;" src="img\products\170.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" style="height:179px ;" src="img\products\171.jpg" alt="single-product">
                                                        <img class="secondary-img" style="height:179px ;"src="img\products\171.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                                ...
                                                <div class="pro-content">
                                                    <div class="pro-info">
                                                        <h4><a href="product.html">Bô Stinger Zin
                                                        </a></h4>
                                                        <p><span class="price">242.000</span> <del class="prev-price">252.500Đ</del></p>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img"  style="height:179px ;"src="img\products\172.jpg" alt="single-product">
                                                        <img class="secondary-img"  style="height:179px ;" src="img\products\173.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                                ...
                                                <div class="pro-content">
                                                    <div class="pro-info">
                                                        <h4><a href="product.html">Bộ bình Xăng Xe Wave</a></h4>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" style="height:179px ;" src="img\products\174.jpg" alt="single-product">
                                                        <img class="secondary-img"  style="height:179px ;" src="img\products\175.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                                ...
                                                <div class="pro-content">
                                                    <div class="pro-info">
                                                        <h4><a href="product.html">
                                                            Baga inox 10 ly màu titan</a></h4>
                                                        <p><span class="price">320.000Đ</span><del class="prev-price">465.000Đ</del></p>
                                                        <div class="label-product l_sale">20<span class="symbol-percent">%</span></div>
                                                    </div>
                                                    <div class="pro-actions">
                                                        <div class="actions-primary">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" style="height:179px ;" src="img\products\176.jpg" alt="single-product"> 
                                                         <img class="secondary-img"style="height:179px ;" src="img\products\176.jpg" alt="single-product"> 
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                                ...
                                                <div class="pro-content">
                                                    <div class="pro-info">
                                                        <h4><a href="product.html">Đầu Đèn FU LED</a></h4>
                                                        <p><span class="price">215.000Đ</span><del class="prev-price">297.000Đ</del></p>
                                                        <div class="label-product l_sale">20<span class="symbol-percent">%</span></div>
                                                    </div>
                                                    <div class="pro-actions">
                                                        <div class="actions-primary">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" style="height:179px ;" src="img\products\177.jpg" alt="single-product">
                                                        <img class="secondary-img"  style="height:179px ;"src="img\products\177.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img"style="height:179px ;" src="img\products\178.jpg" alt="single-product">
                                                        <img class="secondary-img" style="height:179px ;" src="img\products\179.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                                ...
                                                <div class="pro-content">
                                                    <div class="pro-info">
                                                        <h4><a href="product.html">Phuộc Ohlins  Dream </a></h4>
                                                        <p><span class="price">216.000Đ</span><del class="prev-price">230.000Đ</del></p>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" style="height:201px ;"src="img\products\180.jpg" alt="single-product">
                                                        <img class="secondary-img" style="height:201px ;" src="img\products\181.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                                ...
                                                <div class="pro-content">
                                                    <div class="pro-info">
                                                        <h4><a href="product.html">Bình Xăng Xe Exciter</a></h4>
                                                        <p><span class="price">523.000Đ</span><del class="prev-price">744.000Đ</del></p>
                                                        <div class="label-product l_sale">30<span class="symbol-percent">%</span></div>
                                                    </div>
                                                    <div class="pro-actions">
                                                        <div class="actions-primary">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" style="height:201px ;" src="img\products\161.jpg" alt="single-product">
                                                        <img class="secondary-img"  style="height:201px ;"src="img\products\162.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                                ...
                                                <div class="pro-content">
                                                    <div class="pro-info">
                                                        <h4><a href="product.html">Kính H2C chính hãng</a></h4>
                                                        <p><span class="price">453.000Đ</span><del class="prev-price">512.000Đ</del></p>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" style="height: 195px;" src="img\products\163.jpg" alt="single-product">
                                                        <img class="secondary-img"  style="height: 195px;" src="img\products\164.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                                ...
                                                <div class="pro-content">
                                                    <div class="pro-info">
                                                        <h4><a href="product.html">Bình ắc quy DFS </a></h4>
                                                        <p><span class="price">965.000Đ</span><del class="prev-price">973.200Đ</del></p>
                                                        <div class="label-product l_sale">20<span class="symbol-percent">%</span></div>
                                                    </div>
                                                    <div class="pro-actions">
                                                        <div class="actions-primary">
