            ...
            <div class="container">
                <div class="breadcrumb">
                    <ul class="d-flex align-items-center">
                        ...
                        <li class="active"><a href="#">Chăm sóc và bảo dưỡng xe</a></li>
                    </ul>
                </div>
            </div>
            <!-- Container End -->
            ...
            <div class="container">
                <div class="main-blog">
                    <div class="row" style="display: block;">
                        <h1 style="font-weight: bold; padding-bottom: 30px;">Nếu muốn tăng thêm giá trị của xe máy, bạn cần nắm rõ các quy trình cũng như thời gian bảo dưỡng định kỳ. Đây cũng là một trong những yếu tố quan trọng giúp chiếc xe của bạn lâu bền và vận hành êm ái. </h1>
                        <h2 style="padding-bottom: 15px;">1. Trường hợp cần bảo dưỡng xe máy</h2>
                        <p class="text-p">Để đảm bảo rằng xe luôn trong trạng thái tốt, không những bạn phải nhớ thời gian bảo dưỡng định kỳ mà còn cân nhắc đến các yếu tố khác như:</p>
                        <p style="font-size: 20px; padding-right: 200px;">⏩ Đi du lịch hoặc chuyến đi xa<br>
                                ⏩ Đi qua những con đường ngập nước<br>
                                ⏩ Đi đường gồ ghề, nhiều đất đá<br>
                                ⏩ Phát hiện những dấu hiệu bất thường khi sử dụng xe</p>
                        <img style="margin-left: auto; margin-right: auto;" src="img/banner/quy-trinh-cham-soc-bao-duong-xe-may-dinh-ky.jpg" alt="">
                        <h2 style="padding-bottom: 15px; padding-right: 500px;">2. Quy trình bảo dưỡng xe máy Honda định kỳ</h2>
                        <p class="text-p"><br><p style="color: red;">* Bước 1:</p>
                            ...
                            Đồng thời, chống đứng – ngang, gác chân đều phải đảm bảo bôi trơn tốt và chắc chắn</p>
                        <p class="text-p"><p style="color: red;">* Bước 2:</p>
                            ...
                            Kiểm tra khói thải từ động cơ:
                             ...
                             Khói thải màu trắng: động cơ đang bị hỏng hóc hoặc nhớt lọt vào buồng đốt.</p>
                        <p class="text-p"><p style="color: red;">* Bước 3:</p>

                            Thay dầu nhớt khi đã quá cũ hoặc quá hạn, đến kỳ thay nhớt tiếp theo. Điều này sẽ giúp động cơ xe máy luôn được bôi trơn tốt nhất, tăng khả năng vận hành xe và kéo dài tuổi thọ cho động cơ.</p>
                        <p class="text-p"><p style="color: red;">* Bước 4:</p>

                            Kiểm tra hệ thống điện trên xe nhằm đảm bảo khả năng nạp điện cho ắc quy, hỗ trợ tính năng khởi động của động cơ, hệ thống điện đánh lứa luôn hoạt động trong tình trạng tối ưu nhất, tiết kiệm nhiên liệu, tránh lãng phí.</p>
                        <p class="text-p"><p style="color: red;">* Bước 5:</p>

                            Kiểm tra ắc quy: giúp bổ sung điện dịch đúng lúc, đồng thời quan sát các dấu hiệu gây hại cho ắc quy như dịch bị rò rỉ, muối đóng trên cọc bình… Nếu không được xử lý và khắc phục nhanh chóng sẽ mang lại các tác hại nguy hiểm khi bạn tham gia giao thông.</p>
                        <p class="text-p"><p style="color: red;">* Bước 6:</p>

                            Kiểm tra hệ thống xích truyền động: bôi trơn kịp thời sẽ giúp xích vận hành được trơn tru, từ đó giúp xe chạy “mướt” hơn. </p>
                        <p class="text-p"><p style="color: red;">* Bước 7:</p>

                            Kiểm tra khả năng truyền động của bộ ly hợp, bộ phận được xem là một trong những phần quan trọng nhất ảnh hưởng trực tiếp đến sự vận hành của xe máy.</p>
                        <p class="text-p"><p style="color: red;">* Bước 8:</p>

                            Kiểm tra hệ thống phanh tránh bụi bám lâu ngày dày đặc, vệ sinh bên trong đùm xe, dùng mỡ bôi trơn hệ thống bạc đạn nếu cần thiết.</p>
                        <p class="text-p"><p style="color: red;">* Bước 9:</p>
                            ...
                            Vệ sinh hệ thống lọc gió giúp tăng khả năng cung cấp không khí cho động cơ, tiết kiệm nhiên liệu và không làm nóng máy ảnh hưởng đến tính năng vận hành của xe.</p>
                        <p class="text-p"><p style="color: red;">* Bước 10:</p>
