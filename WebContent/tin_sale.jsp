    ...
    <div class="wrapper">
       ...
       <!-- Newsletter Popup Start -->
                        ...
                        <div class="col-xl-9 col-lg-8 col-md-12 ">
                            <nav class="d-none d-lg-block">
                                <ul class="header-bottom-list d-flex">
                                    ...
                                    <li><a href="blog.html">Kinh nghiệm<i class="fa fa-angle-down"></i></a>
                                    ...
                                    <li><a href="#">Tin tức<i class="fa fa-angle-down"></i></a>
                                        <!-- Home Version Dropdown Start -->
                                        <ul class="ht-dropdown dropdown-style-two">
                                            <li><a href="contact.html">Trung tâm đào tạo lái xe</a></li>
                                            <li><a href="register.html">Tin tức về thị trường xe</a></li>
                                        </ul>
                                        <!-- Home Version Dropdown End -->
                                    </li>
                                    <li><a href="#">Tiện Ích<i class="fa fa-angle-down"></i></a>
                                        <!-- Home Version Dropdown Start -->
                                        <ul class="ht-dropdown dropdown-style-two">
                                            <li><a href="contact.html">Mức phạt</a></li>
                                            <li><a href="register.html">Biển báo giao thông</a></li>
                                            <li><a href="login.html">Phí lăn bánh</a></li>
                                        </ul>
                                        <!-- Home Version Dropdown End -->
                                    </li>
                            ...
                            <ul>
                                <li class="has-sub"><a href="#">Xe Máy </a>
                                    <ul class="category-sub">
                                        <li class="has-sub"><a href="shop.html">Mô tô</a>
                                            <ul class="category-sub">
        ...
        <div class="single-blog ptb-100  ptb-sm-60">
            <div class="container">
                 <h1 style="font-style: 30px;position: relative; left: 300px; top: -50px;" >  Xe Máy Giá Vô Cùng Hấp Dẫn !</h1>
                <div class="row">
                    <!-- Single Blog Sidebar Start -->
                    <div class="col-lg-3 order-2 order-lg-1">
                        <aside>
                            <div class="single-sidebar latest-pro mb-30">
                                <h3 class="sidebar-title">Tin Tức Khuyến Mãi</h3>
                                <ul class="sidbar-style">
                                    <li><a href="dichvuchovaytragop.html">. </a></li>
                                    <li><a href="dichvuchovaytragop.html">.</a></li>
                                    <li><a href="dichvuchovaytragop.html">.</a></li>
                                    <li><a href="dichvuchovaytragop.html">.</a></li>
                                </ul>
                            ...
                            <div class="col-img mb-30">
                                <a href="dichvubaohiem.html"><img src="img\products\190.jpg" alt="slider-banner"></a>
                            </div>
                            <div class="single-sidebar mb-30">
                                 <h3 class="sidebar-title">Xem thêm</h3>
                                 <ul class="sidbar-style">
                                     <li><a href="login.html">Đăng Nhập Để Nhận Ưu Đãi</a></li>
                                     <li><a href="#">Đăng Kí Bảo Hiểm Xe <abbr title="Really Simple Syndication">RSS</abbr></a></li>
                                     <li><a href="lambienso.html">Làm Biển Số Theo Tỉnh <abbr title="Really Simple Syndication">RSS</abbr></a></li>
                                     <li><a href="#">.......</a></li>
                                 </ul>
                            </div>
                            <div class="tags">
                    ...
                    <div class="col-lg-9 order-1 order-lg-2">
                        <div class="single-sidebar-desc mb-all-40">
                            <div class="sidebar-img">
                                <img src="img\products\191.jpg" alt="single-blog-img">
                            </div>
                            <div class="sidebar-post-content">
                                <h3 class="sidebar-lg-title">Sự kiện Ngày Lễ Nhà Giáo Việt Nam - Tri Ân giảm giá sốc đến 30% các loại xe</h3>
                                <ul class="post-meta d-sm-inline-flex">
                                    <li><span>Bài đăng bởi</span> An Lưu Văn</li>
                                    <li><span> 13 tháng 11, 2020</span></li>
                                </ul>
                            </div>
                            <div class="sidebar-desc mb-50">
                                <p>  Từ 20/11 đến hết ngày 30/12/2020  Chương trình khuyến mại hấp dẫn "Mua Xe Honda - Nhận Quà Thả Ga", khi mua xe máy Honda bất kỳ, quý khách nhận ngay những món quà tặng hấp dẫn: ? 01 Mũ bảo hiểm nửa đầu ? 01 Móc Khóa Cute...
                                   .
                                   ? 01 Thẻ cứu hộ 24/24h miễn phí 1 năm (xe dưới 175cc)

                                   ? TẶNG thêm gói kiểm tra xe định kỳ (lần 7, lần 8) miễn phí 01 năm
                                   
                                   ? Đặc biệt, từ nay đến hết ngày 15/7/2020 chương trình mua xe WINNER X trả góp với lãi suất 0% tri ân khách hàng “Hè cực thích cùng Winner X” thủ tục đơn giản, nhanh chóng.</p>
                                <blockquote class="mtb-30"> <p>
                                    Tặng ngay 1.000.000 vnđ khi đổi xe máy cũ lấy Winner X dưới hình thức mua xe trả góp sẽ hưởng lãi suất 0%, tặng phí bảo hiểm trách nhiệm dân sự xe máy lên đến 02 năm.

                                    ✅ Hỗ trợ thủ tục đăng ký xe trên 36 tỉnh thành.
                                    
                                    ✅ Hỗ trợ giao xe tận nhà

 
                                   
                                   </p><span>Chủ tiệm xe máy </span></blockquote>
                                <p style="font-weight: bold;">  </p>
                                <br>
                                <p>Đã có hơn 10,6 triệu xe ga được bán ra thị trường tính tới thời điểm này, minh chứng cho thành công của Công ty trong việc nỗ lực đem đến sự thuận lợi cao trong di chuyển cho mọi khách hàng Việt Nam. Do đó, với mong muốn bày tỏ sự tri ân tới những khách hàng luôn tin tưởng thương hiệu Honda, đặc biệt trong mùa tựu trường, Honda Việt Nam thực hiện chương trình tri ân hấp dẫn với tên gọi: “Đi Honda chất. Diện Casio là nhất” dành cho hai mẫu xe tay Honda Vision 110cc và Air Blade 125cc.

                                    Theo đó, trong thời gian từ ngày 15/7/2019 đến hết ngày 15/9/2019, tất cả các khách hàng mua xe Honda Vision 110cc và Air Blade 125cc do Honda Việt Nam phân phối tại các cửa hàng bán xe Honda trên toàn quốc, bao gồm Cửa hàng bán xe và dịch vụ do Honda ủy nhiệm (HEAD) và Cửa hàng bán xe máy tổng hợp sẽ được tặng ngay 1 đồng hồ Casio chính hãng cực chất trị giá lên đến 3 triệu đồn;</p>
                                <br>
                                <img src="img/products/192.jpg" alt="hello">
                                <br>
                                <!-- <ul>
                                    <li> <span style="font-weight: bold;" >--</span> Xe dưới 50cc: 55.000 đồng;</li>
                                    <li><span style="font-weight: bold;" > --</span> Xe trên 50cc: 66.000 đồng</li>
                                    <li><span style="font-weight: bold;" > --</span> Xe mô tô 3 bánh, xe gắn máy và các loại xe cơ giới tương tự: 290.000 VNĐ </li>
                                    <li><span style="font-weight: bold;" > ():</span>Phí bảo hiểm trên đây chưa bao gồm 10% thuế giá trị gia tăng).</li>
                                    <!-- <li><span style="font-weight: bold;" > Bước 5:</span> Sau khi được duyệt cho mua trả góp thì tiến hành ký hợp đồng tín dụng, nộp hồ sơ theo yêu cầu và nộp khoản tiền trả trước.</li> -->
                                </ul> -->
                                <br>
                                <p style="font-weight: bold;">Nếu bạn còn băn khoan hay thắc mắc điều gì , điền thông tin vào ô dưới, nhân viên chúng tôi sẽ gọi điện tư ván cho bạn cảm ơn!</p>
                            </div>
                            <!-- Contact Email Area Start -->
                            <div class="blog-detail-contact">
                                <h3 class="mb-15 leave-reply">Để lại thông tin chúng tôi sẽ tư vấn nhiệt tình</h3>
                                <div class="submit-review">
                                    <form>
                                        ...
                                        <div class="form-group">
                                            <label for="web-address">Số Điện Thoại( ko bắt buộc ):</label>
