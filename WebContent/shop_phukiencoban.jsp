                    ...
                    <div class="col-lg-3 order-2 order-lg-1">
                        <div class="sidebar">
                            ...
                            <div class="electronics mb-40">
                                <h3 class="sidebar-title">Tổng Quan - Phụ kiện Cơ Bản cho xe</h3>
                                    ...
                                    <ul>
                                        ...
                                        <li class="has-sub"><a href="#">Dịch Vụ</a>
                                            <ul class="category-sub">
                                                ...
                                                <li><a href="shop.html">Đăng Kí Bảo Hiểm Xe</a></li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" style="height: 179px;" src="img\products\117.jpg" alt="single-product">
                                                        <img class="secondary-img" style="height: 179px;" src="img\products\118.jpg" alt="single-product">
                                                    </a>
                                                ...
                                                <div class="pro-content">
                                                    <div class="pro-info">
                                                        <h4><a href="product.html">Dầu nhớ xe máy nhiều loại</a></h4>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" style="height:179px ;" src="img\products\119.jpg" alt="single-product">
                                                         <img class="secondary-img" src="img\products\120.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                                ...
                                                <div class="pro-content">
                                                    <div class="pro-info">
                                                        <h4><a href="product.html">Lốp Xe Máy</a></h4>
                                                        <p><span class="price">350.000Đ</span><del class="prev-price">420.000Đ</del></p>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" src="img\products\122.jpg" alt="single-product">
                                                        <img class="secondary-img" src="img\products\121.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                                ...
                                                <div class="pro-content">
                                                    <div class="pro-info">
                                                        <h4><a href="product.html">Săm Xe Máy </a></h4>
                                                        <p><span class="price">97.000Đ</span><del class="prev-price"></del>105.000Đ</del></p>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" src="img\products\123.jpg" alt="single-product">
                                                        <img class="secondary-img" style="height:221px;" src="img\products\124.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                                ...
                                                <div class="pro-content">
                                                    <div class="pro-info">
                                                        <h4><a href="product.html">Nan /Vành Xe Máy</a></h4>
                                                        <p><span class="price">45.000Đ</span> <del class="prev-price">52.000Đ</del></p>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" style="height: 200px;" src="img\products\125.jpg" alt="single-product">
                                                        <img class="secondary-img"  style="height: 200px;" src="img\products\126.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                                ...
                                                <div class="pro-content">
                                                    <div class="pro-info">
                                                        <h4><a href="product.html">Gương -Kính Chiếu Hậu</a></h4>
                                                        <p><span class="price">125.500Đ</span><del class="prev-price">139.000Đ</del></p>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" style="height: 200px;" src="img\products\128.jpg" alt="single-product">
                                                        <img class="secondary-img" style="height: 200px;" src="img\products\127.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                                ...
                                                <div class="pro-content">
                                                    <div class="pro-info">
                                                        <h4><a href="product.html">Tay Phanh Mạnh Mẽ</a></h4>
                                                        <p><span class="price">220.000Đ</span><del class="prev-price">265.000Đ</del></p>
                                                        <div class="label-product l_sale">20<span class="symbol-percent">%</span></div>
                                                    </div>
                                                    <div class="pro-actions">
                                                        <div class="actions-primary">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" style="height: 200px;" src="img\products\129.jpg" alt="single-product"> 
                                                         <img class="secondary-img"style="height: 200px;" src="img\products\130.jpg" alt="single-product"> 
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                                ...
                                                <div class="pro-content">
                                                    <div class="pro-info">
                                                        <h4><a href="product.html">Bugi</a></h4>
                                                        <p><span class="price">215.000Đ</span><del class="prev-price">297000Đ</del></p>
                                                        <div class="label-product l_sale">20<span class="symbol-percent">%</span></div>
                                                    </div>
                                                    <div class="pro-actions">
                                                        <div class="actions-primary">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img"   style="height: 200px;"src="img\products\131.jpg" alt="single-product">
                                                        <img class="secondary-img"   style="height: 200px;"src="img\products\132.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                                ...
                                                <div class="pro-content">
                                                    <div class="pro-info">
                                                        <h4><a href="product.html">Đèn Led Xe Máy</a></h4>
                                                        <p><span class="price">350.000Đ</span> <del class="prev-price">450.000Đ</del></p>
                                                    </div>
                                                    <div class="pro-actions">
                                                        <div class="actions-primary">
                                                            <a href="cart.html" title="Add to Cart"> + Thêm Vào Giỏ Hàng</a>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" src="img\products\133.jpg" alt="single-product">
                                                        <img class="secondary-img" src="img\products\134.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                                ...
                                                <div class="pro-content">
                                                    <div class="pro-info">
                                                        <h4><a href="product.html">Đèn Pha </a></h4>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" src="img\products\135.jpg" alt="single-product">
                                                        <img class="secondary-img" style="height:201px ;" src="img\products\136.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" style="height: 200px;" src="img\products\137.jpg" alt="single-product">
                                                        <img class="secondary-img" style="height: 200px;" src="img\products\138.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                                ...
                                                <div class="pro-content">
                                                    <div class="pro-info">
                                                        <h4><a href="product.html">Nhông Xích</a></h4>
                                                        <p><span class="price">98.000Đ</span><del class="prev-price">151.000Đ</del></p>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" style="height: 195px;" src="img\products\139.jpg" alt="single-product">
                                                        <img class="secondary-img"  style="height: 195px;" src="img\products\140.jpg" alt="single-product">
                                                    </a>
                                                    <a href="#" class="quick_view" data-toggle="modal" data-target="#myModal" title="Quick View"><i class="lnr lnr-magnifier"></i></a>
                                                </div>
                                                <!-- Product Image End -->
                                                ...
                                                <div class="pro-content">
                                                    <div class="pro-info">
                                                        <h4><a href="product.html">Ghi- Đông</a></h4>
                                                        <p><span class="price">650.000Đ</span><del class="prev-price">732.000Đ</del></p>
                                                        <div class="label-product l_sale">20<span class="symbol-percent">%</span></div>
                                                    </div>
                                                    <div class="pro-actions">
                                                        <div class="actions-primary">
