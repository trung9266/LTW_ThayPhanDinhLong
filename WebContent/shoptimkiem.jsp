                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 order-2 order-lg-1">
                        <div class="sidebar">
                            ...
                            <form action="http://localhost:8080/DoAnGiuaKiWeb/shoptimkiem?index=1" method="post" class="">
                            ...
                            <div class="tab-content fix">
                                ...
                                <!--Bắt đầu nàm ở đây  -->
                                    ...
                                    <div class="row">
                                        <!-- Single Product Start -->
                                        <%
                              ArrayList<Sanpham> arrListSanPhamtimkiem =(ArrayList) request.getAttribute("arrListSanPhamtimkiem");
                           
                                 for (int i=0;i<arrListSanPhamtimkiem.size();i++){
                              ...
                              %> 
                                         <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                            ...
                                            <div class="single-product">
                                                ...
                                                <div class="pro-img">
                                                    <a href="product.html">
                                                        <img class="primary-img" style="height: 179px;" src=<%=arrListSanPhamtimkiem.get(i).getImage1() %> alt="single-product">
                                                        <img class="secondary-img" style="height: 179px;" src=<%=arrListSanPhamtimkiem.get(i).getImage2() %> alt="single-product">
                                                    </a>
                                                ...
                                                <div class="pro-content">
                                                    <div class="pro-info">
                                                        <h4><a href="product.html"><%= arrListSanPhamtimkiem.get(i).getTen()%></a></h4>
                                                        <p><span class="price"><%= arrListSanPhamtimkiem.get(i).getPricegiamgia()%></span><del class="prev-price"><%=arrListSanPhamtimkiem.get(i).getPrice() %></del></p>
                                                        <div class="label-product l_sale"> <%= arrListSanPhamtimkiem.get(i).mucgiamgia()%> <span class="symbol-percent">%</span></div>
                                                    </div>
                                                    <div class="pro-actions">
                                                        <div class="actions-primary">
                                                            <a href="http://localhost:8080/DoAnGiuaKiWeb/cartServlet?idcart=<%= arrListSanPhamtimkiem.get(i).getId()%>" title="Add to Cart"> + Thêm Vào Giỏ Hàng</a>
                                                        </div>
                                ...
                                <div class="pro-pagination">
                                    <ul class="blog-pagination">
                                     <%
                              int pageSpedit = (int)request.getAttribute("pageSpedit");
                                  for(int i=1;i <=pageSpedit;i++){
    
                              %>

                              <li class="active"><a href="http://localhost:8080/DoAnGiuaKiWeb/shoptimkiem?index=<%=i%>&search=<%=request.getAttribute("search") %>"><%=i %></a></li>
                                                   <%
                                 }
                                             %>
                                    </ul>                                    
                                    ...
                                    <%  String  a = (String)request.getAttribute("search");
                                     if(a != null){
                                    %>
                                        <span class="grid-item-list">Showing 12 sản phẩm mỗi lần</span>
                                                         <%
                                 }
                                             %>
                                    </div>
