                    ...
                    <div class="col-md-6">
                        <div class="well mb-sm-30">
                            <div class="new-customer">
                                <h3 class="custom-title">Đăng kí thành viên mới</h3>
                    ...
                    <div class="col-md-6">
                        <div class="well">
                            <div class="return-customer">
                                ...
                                <form action="http://localhost:8080/DoAnGiuaKiWeb/Checklogin" method="post">
                                    <div class="form-group">
                                        <label>Tên đăng nhập:</label>
                                        <input type="text" name="enteremail" placeholder="Enter your email address..." id="input-email" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Mật khẩu:</label>
                                        <input type="password" name="enterpwd" placeholder="Password" id="password" class="form-control">
                                    </div>
