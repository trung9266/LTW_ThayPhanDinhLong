        ...
        <nav id="sidebar" class="">
			...
			<div class="nalika-profile">
				<div class="profile-dtl">
					...
					<h2>Văn An<span class="min-dtn"> + Hoàng Trung</span></h2>
				</div>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                ...
                                <li><a title="Product Edit" href="Producer.html"><span class="mini-sub-pro">Nhà Cung Cấp </span></a></li>
                                    ...
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">Home <span class="admin-project-icon nalika-icon nalika-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                <!-- <li><a href="index.html">Đăng Sản Phẩm</a></li>
                                        ...
                                        <li><a data-toggle="collapse" data-target="#Pagemob" href="#">Pages <span class="admin-project-icon nalika-icon nalika-down-arrow"></span></a>
                                            <ul id="Pagemob" class="collapse dropdown-header-top">
                                                <li><a href="login.html">Đăng Nhập>
                                                </li>
                                                <li><a href="register.html">Đăng Kí</a>
                                                </li>
                                                <!-- <li><a href="lock.html">Lock</a> -->
                                                </li>
                                                <li><a href="password-recovery.html">Quên mật khẩu</a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcomb-wp">
											...
											<div class="breadcomb-ctn">
												<h2>Cài đặt Website Smile Bike</h2>
												<p>Chào mừng bạn đã trở lại <span class="bread-ntd">Admin Văn An</span></p>
											</div>
										</div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="icon nalika-edit" aria-hidden="true"></i> Cài đặt</a></li>
                                    <!-- <li><a href="#reviews"><i class="icon nalika-picture" aria-hidden="true"></i> Ảnh</a></li> -->
                                    <!-- <li><a href="#INFORMATION"><i class="icon nalika-chat" aria-hidden="true"></i> Bình luận - Review</a></li> -->
                                </ul>
                                <div id="myTabContent" class="tab-content custom-product-edit">
                                <form action="CaidatAdmin" method="post">
                                    <div class="product-tab-list tab-pane fade active in" id="description">
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt" style="position: relative;right: -170px;">
                                                        <p style="font-size: larger;">TIÊU ĐỀ TRANG  WEB INDEX NGƯỜI DÙNG</p>
                                                        <!-- <span class="input-group-addon" ><i class="icon nalika-user"  aria-hidden="true"></i></span> -->
                                                        <!-- <input type="textarea" class="form-control" placeholder="Tên sản phẩm"> -->
                                                        <textarea  name="textarea" rows="12" cols="150" >Shop thương mại điện tử chuyên bán các đồ Về Xe Máy và Các Phụ Kiện Liên Quan Giá thành rẻ nhất Việt Nam...</textarea>
                                                    </div>
                                                    
                                                    <p style="font-size: larger; text-align: right;position: relative;right: -100px;" >Giảm Giá Xe Toàn Bộ Hoặc Theo Hãng Hoặc Mã Sản Phẩm</p>
                                                    <div class="input-group mg-b-pro-edt" style="flex; margin-top: 20px;">
                                                        
                                                        <select name="selecthangxe" class="form-control pro-edt-select form-control-primary">									
															<option value="Honda">Honda</option>
															<option value="Vespa">Vespa</option>
															<option value="Exciter">Exciter</option>
															<option value="Way">Way</option>
                                                            <option value="SH">SH</option>
                                                            <option value="khongchon">Không Chọn</option>
														</select>
                                                    ...
                                                    <div class="input-group mg-b-pro-edt" style="position: relative;right: -180px;top: -55px;">
                                                        
                                                        <select name="selectgiamgia" class="form-control pro-edt-select form-control-primary">
                                                    ...
                                                    <input name="masanpham" style="position: relative;right: -420px;top: -110px;" type="text" class="form-control" placeholder="Mã Sản Phẩm">
                                                    ...
                                                    <!-- <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Chất Lượng">
                                                    </div> -->
                                                </div>
                                            </div>
                                            <!-- <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control" placeholder="Giá Cuối cùng">
                                                    </div>
                                                    <!-- <div class="input-group mg-b-pro-edt">
                                                    ...
                                                    <!-- <select name="select" class="form-control pro-edt-select form-control-primary">
															<option value="opt1">Thể Loại Xe</option>
															<option value="opt2">Honda</option>
															<option value="opt3">Vespa</option>
															<option value="opt4">Exciter</option>
															<option value="opt5">Way</option>
															<option value="opt6">SH</option>
														</select>
                                                </div>
                                            </div>
                                        </div> --> -->
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <div class="text-center custom-pro-edt-ds">
                                                    <button type="submit" class="btn btn-ctl-bt waves-effect waves-light m-r-10">Lưu Lại
														</button>
                                                    <button type="button" class="btn btn-ctl-bt waves-effect waves-light">Loại bỏ
														</button>
                                                </div>
                                            </div>
                                        </div>
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <div class="product-edt-pix-wrap">
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="text" class="form-control" placeholder="Ảnh 1">
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="col-lg-6">
                                                                                <div class="form-radio">
                                                                                    <form>
                                                                                        <div class="radio radiofill">
                                                                                            <label>
																									<input type="radio" name="radio"><i class="helper"></i>Ảnh 1
																								</label>
                                                                                        </div>
                                                                                        <div class="radio radiofill">
                                                                                            <label>
																									<input type="radio" name="radio"><i class="helper"></i>Ảnh 2
																								</label>
                                                                                        </div>
                                                                                        <div class="radio radiofill">
                                                                                            <label>
																									<input type="radio" name="radio"><i class="helper"></i>Ảnh 3
																								</label>
                                                                                        </div>
                                                                                    </form>
                                                                                </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                    <div class="product-edt-pix-wrap">
                                                                        <div class="input-group">
                                                                            <span class="input-group-addon"></span>
                                                                            <input type="text" class="form-control" placeholder="Ảnh 2">
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="col-lg-6">
                                                                                <div class="form-radio">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <div class="product-edt-pix-wrap">
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="text" class="form-control" placeholder="Ảnh 3">
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="col-lg-6">
                                                                                <div class="form-radio">
                                                ...
                                                <div class="review-content-section">
                                                    <div class="card-block">
                                                        ...
                                                        <div class="input-group mg-b-15" >
                                                            <span class="input-group-addon"><i class="icon nalika-user" aria-hidden="true"></i></span>
                                                            <input type="text" class="form-control" placeholder="Tên cuối cùng">
                                                        </div>
                                                        <div class="input-group mg-b-15">
                                                        ...
                                                        <div class="form-group review-pro-edt mg-b-0-pt">
                                                            <button type="submit" class="btn btn-ctl-bt waves-effect waves-light">Lưu Lại
																</button>
                                                        </div>
                                                    </div>
                                                </div>
