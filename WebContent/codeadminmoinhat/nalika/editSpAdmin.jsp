						...
						<div class="container">
                                <div class="panel panel-primary">
                                    ...
                                    <% Sanpham sanpham = (Sanpham)session.getAttribute("sanpham"); %>
                                        <form action="http://localhost:8080/DoAnGiuaKiWeb/editSpAdminUpdate?index=1" method="post">
                                        <div class="form-group">
                                            <label style="color: #fff" for="ten">ID:</label>
                                                          <input required="true" type="text" class="form-control" placeholder="ID" id="id" name="id" value="<%=sanpham.getId()%>"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for="ten">Tên:</label>
                                                          <input  type="text" class="form-control" placeholder="Tên sản phẩm" id="ten" name="ten" value="<%=sanpham.getTen()%>"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for="image1">Hình1:</label>
                                                          <input  type="text" class="form-control" id="image1" name="image1" value="<%=sanpham.getImage1()%>"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for="image2">Hình2:</label>
                                                          <input type="text" class="form-control" id="image2"  name="image2" value="<%=sanpham.getImage2()%>"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for="image3">Hình3:</label>
                                                          <input  type="text" class="form-control" id="image3" name="image3"value="<%=sanpham.getImage3()%>"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for="image4">Hình4:</label>
                                                          <input  type="text" class="form-control" id="image4" name="image4"value="<%=sanpham.getImage4()%>"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for="price">Giá:</label>
                                                          <input  type="text" class="form-control" placeholder="Giá sản phẩm"  id="price" name="price" value="<%=sanpham.getPrice()%>"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for="phankhoi">Phân khối:</label>
                                                          <input  type="text" class="form-control" placeholder="Phân khối" id="phankhoi" name="phankhoi" value="<%=sanpham.getPhankhoi() %>"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for="pricegiamgia">Giảm giá:</label>
                                                          <input  type="text" class="form-control" placeholder="Giá đã giảm" id="pricegiamgia" name="pricegiamgia" value="<%=sanpham.getPricegiamgia()%>"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for="status">Trạng thái:</label>
                                                          <input  type="text" class="form-control" placeholder="Trạng thái" id="status" name="status" value="<%=sanpham.getStatus()%>"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for="description">Mô tả:</label>
                                                          <input  type="text" class="form-control" placeholder="Mô tả" id="description" name="description" value="<%=sanpham.getDescription()%>"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for="information">Thông tin:</label>
                                                          <input  type="text" class="form-control" placeholder="Thông tin" id="information" name="information" value="<%=sanpham.getInformation()%>"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for="comment">Bình luận:</label>
                                                          <input  type="text" class="form-control"  id="comment" name="comment" value="<%=sanpham.getComment()%>"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for="phanloai">Phân loại:</label>
                                               <input type="text" class="form-control" id="phanloai" name="phanloai" value="<%=sanpham.getPhanloai()%>"/>
                                        </div>
                                        <button style="margin-left: 47%; margin-right: 47%;" type="submit" class="btn btn-success">Sửa</button>
                                        </form>
                                    </div>
                                </div>
                            </div>   
