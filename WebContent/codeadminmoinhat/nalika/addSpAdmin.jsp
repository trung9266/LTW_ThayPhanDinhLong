...
<link rel="shortcut icon" type="image/x-icon"
	href="http://localhost:8080/DoAnGiuaKiWeb/codeadminmoinhat/nalika/img/favicon.ico">
<!-- Google Fonts
		============================================ -->
<link
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<div class="container">
                                <div class="panel panel-primary">
                                    <div style="background: #152036" class="panel-heading">
                                        <h2  class="text-center">Thêm sản phẩm</h2>
                                    </div>
                                    <div class="panel-body" style="background: #020B2E; border-color: #000">
                                        <form action="http://localhost:8080/DoAnGiuaKiWeb/addAdminControll?index=1" method="post"> 
                                        <div class="form-group">
                                            <label style="color: #fff" for="id">ID:</label>
                                                          <input required="true" type="text" class="form-control" placeholder="ID" id="id" name="id"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for="ten">Tên:</label>
                                                          <input required="true" type="text" class="form-control" placeholder="Tên sản phẩm" id="ten" name="ten"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for="image1">Hình1:</label>
                                                          <input required="true" type="text" class="form-control" value="http://localhost:8080/DoAnGiuaKiWeb/img/products/" id="image1" name="image1"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for="image2">Hình2:</label>
                                                          <input type="text" class="form-control" id="image2" value="http://localhost:8080/DoAnGiuaKiWeb/img/products/" name="image2"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for="image3">Hình3:</label>
                                                          <input required="true" type="text" class="form-control" value="http://localhost:8080/DoAnGiuaKiWeb/img/products/" id="image3" name="image3"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for="image4">Hình4:</label>
                                                          <input required="true" type="text" class="form-control" value="http://localhost:8080/DoAnGiuaKiWeb/img/products/" id="image4" name="image4"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for="price">Giá:</label>
                                                          <input required="true" type="text" class="form-control" placeholder="Giá sản phẩm"  id="price" name="price"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for="phankhoi">Phân khối:</label>
                                                          <input required="true" type="text" class="form-control" placeholder="Phân khối" id="phankhoi" name="phankhoi"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for="pricegiamgia">Giảm giá:</label>
                                                          <input required="true" type="text" class="form-control" placeholder="Giá đã giảm" id="pricegiamgia" name="pricegiamgia"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for="status">Trạng thái:</label>
                                                          <input required="true" type="text" class="form-control" placeholder="Trạng thái" id="status" name="status"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for="description">Mô tả:</label>
                                                          <input required="true" type="text" class="form-control" placeholder="Mô tả" id="description" name="description"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for="information">Thông tin:</label>
                                                          <input required="true" type="text" class="form-control" placeholder="Thông tin" id="information" name="information"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for="comment">Bình luận:</label>
                                                          <input required="true" type="text" class="form-control" placeholder="Bình luận" id="comment" name="comment"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for="phanloai">Phân loại:</label>
                                                          <input required="true" type="text" class="form-control" placeholder="Phân loại" id="phanloai" name="phanloai"/>
                                        </div>
                                        <button style="margin-left: 47%; margin-right: 47%;" type="submit" class="btn btn-success">Thêm</button>
                                        </form>
                                    </div>
                                </div>
                            </div>   
