                    ...
                    <div class="panel-body">
                        <form action="#" id="loginForm">
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6">
                                    <label>Nhập lại địa chỉ email (quan trọng )</label>
                                    <input class="form-control">
                                </div>
                                <div class="checkbox col-lg-12">
                                    <input type="checkbox" class="i-checks" checked> Tôi đã đồng ý các điều khoản của shop
                                </div>
                            </div>
                            <div class="text-center">
                                <button class="btn btn-success loginbtn">Đăng Kí </button>
