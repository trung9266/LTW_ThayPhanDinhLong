						...
						<div class="container">
                                <div class="panel panel-primary">
                                    ...
                                    <% User user = (User)session.getAttribute("user"); %>
                                        <form action="http://localhost:8080/DoAnGiuaKiWeb/EditUserAdminUpdate?index=1" method="post"> 
                                        <div class="form-group">
                                            <label style="color: #fff" for="id">User ID:</label>
                                                          <input required="true" type="text" class="form-control" placeholder="ID" id="id" name="id" value="<%=user.getId()%>"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for="ten">Name:</label>
                                                          <input required="true" type="text" class="form-control" placeholder="Name" id="ten" name="name" value="<%=user.getName()%>"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for="image1">Phone:</label>
                                                          <input required="true" type="text" class="form-control"  id="phone" name="phone" value="<%=user.getPhone()%>"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for="image2">Email:</label>
                                                          <input type="text" class="form-control" id="email" name="email" value="<%=user.getEmail()%>"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for="image3">Address:</label>
                                                          <input required="true" type="text" class="form-control" id="address" name="address" value="<%=user.getAddress()%>"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for="image4">Sex:</label>
                                                          <input required="true" type="text" class="form-control" id="gioitinh" name="gioitinh" value="<%=user.getGioitinh()%>"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for="price">Password:</label>
                                                          <input required="true" type="text" class="form-control" placeholder="Password"  id="price" name="password" value="<%=user.getId()%>"/>
                                        </div>
