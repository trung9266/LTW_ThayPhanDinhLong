                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <table>
                                ...
                                <%
								ArrayList<User> arrListUser = (ArrayList) request.getAttribute("arrListUser");
								if (arrListUser != null) {
									for (int i = 0; i < arrListUser.size(); i++) {
								%>
                                <tr>
                                    <td><%=arrListUser.get(i).getId() %></td>
                                    <td><%=arrListUser.get(i).getName() %></td>
                                    <td><%=arrListUser.get(i).getPhone() %></td>>
                                    <td><%=arrListUser.get(i).getEmail() %></td>
                                    <td><%=arrListUser.get(i).getAddress() %></td>
                                    <td><%=arrListUser.get(i).getGioitinh() %></td>
                                    <td><%=arrListUser.get(i).getPassword() %></td>
                                    <td>
										<a href="http://localhost:8080/DoAnGiuaKiWeb/EditUserAdmin?id=<%=arrListUser.get(i).getId()%>">Sửa</a>
										<a href="http://localhost:8080/DoAnGiuaKiWeb/QLUser?id=<%=arrListUser.get(i).getId()%>&index=1">Xóa</a>
									</td>
                                </tr>
                                <%
									}
                            ...
                            <div class="custom-pagination">
								<ul class="pagination">
									<%
										int pageUseradmin = (int) request.getAttribute("pageUseradmin");
									if (pageUseradmin != 0) {
										for (int i = 0; i < pageUseradmin; i++) {
									%>
									<li class="page-item"><a class="page-link"
										href="http://localhost:8080/DoAnGiuaKiWeb/QLUser?indexpage=<%=i%>"><%=i%></a></li>
									<%
										}
									}
									%>
