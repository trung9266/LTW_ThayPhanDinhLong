                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                ...
                                <li><a title="Analytics" href="analytics.html"><span class="mini-sub-pro">Phân Tích</span></a></li>
                        ...
                        <li id="removable">
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li><a title="Password Recovery" href="password-recovery.html"><span class="mini-sub-pro">Quên mật khẩus</span></a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
                                    ...
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">Home <span class="admin-project-icon nalika-icon nalika-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                ...
                                                <li><a href="user.html">User / Chức Vụ</a></li>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcomb-wp">
											...
											<div class="breadcomb-ctn">
												<h2>Danh Sách Các Nhà Cung Cấp Cho Shop</h2>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <div class="add-product">
                                <a href="product-edit.html">Thêm Nhà Cung Cấp</a>
                            </div>
                            <table>
                                <tr>
                                    <th>Mã User </th>
                                    ...
                                    <th>Địa chỉ</th>
                                    <th>Số Điện Thoại</th>
                                    <th>Thao tác (Xóa, Thêm,Hạ Quyền)</th>
                                </tr>
                                <tr>
                                    <td>326436</td>
                                    <td><img src="img/product/1111.jpg" alt="" /></td>
                                  
                                    <td>Hoàng Văn Đạt</td>
                                    <td>
                                        <button class="pd-setting">Khách Hàng</button>
                                    </td>
                                    <td>datthanh9x@gmail.com</td>
                                    <td>Quận 1, Tôn Thất Thuyết Tp hcm</td>
                                    <!-- <td>Mẫu Xe Mạnh mẽ ,cá tính, hot nhất năm 2020....</td> -->
                                    <!-- <td>787615</td> -->
                                    <!-- <td>44.000.000</td> -->
                                    <td>082 3536 242</td>
                                    <td>
                                ...
                                <tr>
                                    <td>525235</td>
                                    <td><img src="img/product/11112.jpg" alt="" /></td>
                             
                                    <td>Nguyễn Châu Thuận</td>
                                    <td>
                                        <button class="ps-setting">Quản trị viên 2</button>
                                    </td>
                                    <td>thuandang1998@hotmail.com</td>
                                    <td>Q.Thủ Đức, Làng Đh -TP.hcm</td>
                                    <!-- <td>Honda RSX luôn mang lại cho bạn sự an toàn,chắc...</td>
                                    <td>987631</td>
                                    <td>31.750.000</td> -->
                                    <td>09 75442 976</td>
                                    <td>
                                ...
                                <tr>
                                    <td>654245</td>
                                    <td><img src="img/product/11113.jpg" alt="" /></td>
                                
                                    <td>Tư Mã Ý</td>
                                    <td>
                                        <button class="ds-setting">Khách Vãng Lai</button>
                                    </td>
                                    <td>ythientaitroi@us.com</td>
                                    <td>Long Khánh -Bà Rịa Vũng Tàu</td>
                                    <!-- <td>Mẫu Xe Cực Kì Được yêu thích bởi giới trẻ..</td>
                                    <td>769834</td>
                                    <td>13.600.000</td> -->
                                    <td>082 54631 754</td>
                                    <td>
                                ...
                                <tr>
                                    <td>153463</td>
                                    <td><img src="img/product/11114.jpg" alt="" /></td>
                                  
                                    <td>Mã Văn Trung</td>
                                    <td>
                                        <button class="pd-setting">Khách Hàng</button>
                                    </td>
                                    <td>degiacatluong@mlem.com</td>
                                    <td>Sông Đồng Nai - Đường 9 Nam Lào</td>
                                    <td>082 64632 353</td>
                                    <!-- <td>Vespa phiên Bản Limited Cực Kì Hót..</td>
                                    <td>215152</td>
                                    <td>36.530.000</td> -->
                                    <td>
                                        <button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
                                ...
                                <tr>
                                    <td>475475</td>
                                    <td><img src="img/product/11115.jpg" alt="" /></td>
                             
                                    <td>Hà Thiên Dịch</td>
                                    <td>
                                        <button class="pd-setting">Khách Hàng</button>
                                    </td>
                                    <td>ZerosTop987@gmail.com</td>
                                    <td>Phường Bến Ngé - Quận 2- Tphcm</td>
                                    <td>075 8457 878</td>
                                    <!-- <td>Phiên Bản SH mới nhất, hứa hẹn sẽ cháy hàng.</td>
                                    <td>543643</td>
                                    <td>72.640.000</td> -->
                                    <td>
                                        <button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
                                ...
                                <tr>
                                    <td>8676235</td>
                                    <td><img src="img/product/11116.jpg" alt="" /></td>
                                    
                                    <td>Tôn Hành Giả</td>
                                    <td>
                                        <button class="ps-setting">Nhân viên</button>
                                    </td>
                                    <td>giahanhton99@tk.es</td>
                                    <td>Hồ Đá - Bình Dương</td>
                                    <td>033 6666 999</td>
                                    <!-- <td>Made In Việt Nam, Ngoại hình bắt mắt.....</td>
                                    <td>463643</td>
                                    <td>10.700.000</td> -->
                                    <td>
                                        <button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
