                                ...
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body" style="background: #020B2E; border-color: #000">
                                     <% Producer producer = (Producer)session.getAttribute("producer"); %>
                                        <form action="http://localhost:8080/DoAnGiuaKiWeb/EditProducerAdminUpdate?index=1" method="post"> 
                                        <div class="form-group">
                                            <label style="color: #fff" for="id">Producer ID:</label>
                                                          <input type="text" class="form-control" value="<%=producer.getId_producer()%>" id="id" name="id"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for=tennhacungcap>Name Producer:</label>
                                                          <input type="text" class="form-control" value="<%=producer.getTennhacungcap()%>" id="tennhacungcap" name="tennhacungcap"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for="image">Image:</label>
                                                          <input type="text" class="form-control" id="image" value="<%=producer.getImage()%>" name="image"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for="status">Status:</label>
                                                          <input required="true" type="text" class="form-control" value="<%=producer.getStatus()%>" id="status" name="status"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for="email">Email:</label>
                                                          <input required="true" type="text" class="form-control" value="<%=producer.getEmail()%>" id="email" name="email"/>
                                        </div>
                                        <div class="form-group">
                                            <label style="color: #fff" for="diachi">Address:</label>
                                                          <input required="true" type="text" class="form-control" value="<%=producer.getDiachi()%>" id="diachi" name="diachi"/>
                                        </div>
