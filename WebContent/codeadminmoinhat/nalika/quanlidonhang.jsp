                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li><a title="Compose Mail" href="mailbox-compose.html"><span class="mini-sub-pro">Gửi Mail</span></a></li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <div class="mobile-menu">
                                <nav id="dropdown">
                                    <ul class="mobile-menu-nav">
                                        ...
                                        <li><a data-toggle="collapse" data-target="#demo" href="#">Tin Nhắn <span class="admin-project-icon nalika-icon nalika-down-arrow"></span></a>
                                            <ul id="demo" class="collapse dropdown-header-top">
                                                <li><a href="mailbox.html">Tin nhắn</a>
                                                <!-- </li>
                                                <li><a href="mailbox-view.html">View Mail</a> -->
                                                </li>
                                                <li><a href="mailbox-compose.html">Gửi thư</a>
                                                </li>
                                            </ul>
                                        </li>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <table>
                                ...
                                <tr>
                                    <td>326436</td>
                                    <td><img src="img/product/11.jpg" alt="" /></td>
                                  
                                    <td>Công Ti Tinh Á Châu</td>
                                    <td>
                                        <button class="pd-setting">Đang Giao Hàng</button>
                                    </td>
                                    <td>232532</td>
                                    <td>1</td>
                                ...
                                <tr>
                                    <td>525235</td>
                                    <td><img src="img/product/12.jpg" alt="" /></td>
                             
                                    <td>Công Ti Maphite Hcm</td>
                                    <td>
                                        <button class="ps-setting">Đã Giao Hàng</button>
                                    </td>
                                    <td>135122</td>
                                    <td>2</td>
                                    <td>856463</td>
                                ...
                                <tr>
                                    <td>654245</td>
                                    <td><img src="img/product/13.png" alt="" /></td>
                                
                                    <td>Công Ti Thành Tiến MTV</td>
                                    <td>
                                        <button class="ds-setting">Tạm Ngưng Do Lỗi</button>
                                    </td>
                                    <td>354523</td>
                                    <td>3</td>
                                    <td>432533</td>
                                ...
                                <tr>
                                    <td>153463</td>
                                    <td><img src="img/product/14.jpg" alt="" /></td>
                                  
                                    <td>Công ti cổ phần Phú Đại</td>
                                    <td>
                                        <button class="pd-setting">Đang Giao Hàng</button>
                                    </td>
                                    <td>462535</td>
                                ...
                                <tr>
                                    <td>475475</td>
                                    <td><img src="img/product/15.jpg" alt="" /></td>
                             
                                    <td>Công Ti Zeros One</td>
                                    <td>
                                        <button class="pd-setting">Hết Hàng</button>
                                    </td>
                                    <td>734333</td>
                                    <td>5</td>
                                    <td>532533</td>
                                ...
                                <tr>
                                    <td>8676235</td>
                                    <td><img src="img/product/16.jpg" alt="" /></td>
                                    
                                    <td>Công Ti Xe Máy Thành Long</td>
                                    <td>
                                        <button class="ps-setting">Đang Giao Hàng</button>
                                    </td>
                                    <td>632535</td>
                                    <td>6</td>
                                    <td>521214</td>
