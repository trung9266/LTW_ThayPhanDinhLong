...
<head>
    ...
    <!-- favicon
		============================================ -->
    <link rel="shortcut icon" type="image/x-icon" href="http://localhost:8080/DoAnGiuaKiWeb/codeadminmoinhat/nalika/img/favicon.ico">
    <!-- Google Fonts
		============================================ -->
                                    ...
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">Home <span class="admin-project-icon nalika-icon nalika-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                ...
                                                <li><a href="user.jsp">User / Chức Vụ</a></li>
                                                <li><a title="Analytics" href="caidat.jsp".jsp"><span class="mini-sub-pro">Cài Đặt WEB</span></a></li>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <table>
                                ...
                                <% 
                                 ArrayList<DonHang> arrDonHang = (ArrayList)request.getAttribute("arrDonHang");
                                   for (int i=0;i<arrDonHang.size();i++){
                                
                                %>
                                <tr>
                                
                                    <td><%= arrDonHang.get(i).getID_Donhang() %></td>
                                    <td><img src= <%= arrDonHang.get(i).getImage() %> alt="" /></td>
                                  
                                    <td><%= arrDonHang.get(i).getTennguoimua() %></td>
                                    
                                    <td><%= arrDonHang.get(i).getSdt() %></td>
                                    <td><%= arrDonHang.get(i).getDiachi() %></td>
                                    <td>
                                        <button class="pd-setting"><%= arrDonHang.get(i).getStatus()%></button>
                                    </td>
                           
                                    <td><%= arrDonHang.get(i).getSoluong() %></td>
                                    <td><%= arrDonHang.get(i).getTongtien() %></td>
                                    <td>
                                    <button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>   
          <a href="http://localhost:8080/DoAnGiuaKiWeb/DonhangAdmin?index=1&idxoa=<%= arrDonHang.get(i).getID_Donhang() %>">  <button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button> </a>      
                                    </td>
                                </tr>
                                <%
                            ...
                            <div class="custom-pagination">
								<ul class="pagination">
								<%
								  int pageDh = (int)request.getAttribute("pageDh");
                                          if ( pageDh !=0){
                                        	  for(int i=0;i <= pageDh;i++){
                                        		  
                                        	
								%>
								
									<li class="page-item"><a class="page-link" href="http://localhost:8080/DoAnGiuaKiWeb/DonhangAdmin?index<%=i  %>">1</a></li>
