...
<head>
    ...
    <title>Mail Compose | Nalika - Material Admin Template</title>
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li class="active">
                            <a class="has-arrow" href="mailbox.html" aria-expanded="false"><i class="fa big-icon fa-envelope icon-wrap"></i> <span class="mini-click-non">Tin Nhắn</span></a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Gửi Mail</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-3 col-md-3 col-sm-3 col-xs-12">
                        <div class="hpanel responsive-mg-b-30">
                            <div class="panel-body">
                                <a href="mailbox_compose.html" class="btn btn-success compose-btn btn-block m-b-md">--Gửi Thư---</a>
                                ...
                                <ul class="mailbox-list">
                                    <li>
                                        <a href="#"><i class="fa fa-plane text-danger"></i> Khách hàng thân thiết</a>
                                    </li>
                                    <li>
                                        <a href="#"><i class="fa fa-bar-chart text-warning"></i> Khách hàng vãng lai</a>
                                    </li>
                                    <li>
                                        <a href="#"><i class="fa fa-users text-info"></i> Khách VIP</a>
                                    </li>
                                    <li>
                                        <a href="#"><i class="fa fa-tag text-success"></i> Khách Lần đầu</a>
                                    </li>
                                    <li>
                                        <a href="#"><i class="fa fa-flag text-primary"></i> Cập nhật</a>
                                    </li>
                                </ul>
                                <hr>
                                <ul class="mailbox-list">
                        ...
                        <div class="hpanel email-compose mg-b-15">
                                ...
                                <div class="p-xs">
                                    <form method="get" class="form-horizontal">
                                        <div class="form-group">
                                            <label class="col-sm-1 control-label text-left">Đến:</label>
                                            <div class="col-sm-11">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-1 control-label text-left">Tiêu Đề:</label>
                                            <div class="col-sm-11">
                                                <input type="text" class="form-control input-sm" placeholder="Vui Lòng Điền Tiêu đề email">
                                            </div>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div class="panel-body no-padding">
                                <div class="summernote6">
                                    <h5>Chào Văn An! </h5>
                                    <p>Chúng tôi đã nhận được câu trả lời của bạn về vấn đề đơn hàng số 253422</strong> Chúng tôi đã kiểm tra kĩ và đã nhận thấy rằng đây là một sai sót bên phía giao hàng
                                        <br/>
                                        <br/>Bởi vì điều đó chúng tôi sẽ quyết định một là sẽ hoàn trả lại số tiền bạn đã đưa cho bên vận chuyển GHTK hai là bạn có thể đặt mua một món đồ đồng giá trên shop của mình và giá sẽ rẻ hơn 15% ! Thân ái.</p>
                                    <p>Văn An 
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="panel-footer">
                                <div class="pull-right">
                                    <div class="btn-group">
                                        <button class="btn btn-default"><i class="fa fa-edit"></i> Lưu</button>
                                        <button class="btn btn-default"><i class="fa fa-trash"></i> Loại bỏ</button>
                                    </div>
                                </div>
                                <button class="btn btn-primary ft-compse">Gửi Email</button>
                                <div class="btn-group">
