					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="product-status-wrap">
							...
							<table>
								...
								<%
									ArrayList<Sanpham> arrListSanPhamAdmin = (ArrayList) request.getAttribute("arrListSanPhamAdmin");
								if (arrListSanPhamAdmin != null) {
								...
								<tr>
									...
									<td><%=arrListSanPhamAdmin.get(i).getId()%></td>    
									<td><img style="height: 200px; width: 300px"
										src="<%=arrListSanPhamAdmin.get(i).getImage1()%>" alt="" /></td>

									<td><%=arrListSanPhamAdmin.get(i).getTen()%></td>
									<td>
										<button class="pd-setting">Đang Hoạt Động</button>
									</td>
									<td><%=arrListSanPhamAdmin.get(i).getPrice()%></td>
									<td><%=total = arrListSanPhamAdmin.get(i).getPrice() - arrListSanPhamAdmin.get(i).getPricegiamgia()%></td>
									<td><%=arrListSanPhamAdmin.get(i).getInformation().substring(0, 30)%></td>
									<td>787615</td>
									<td><%=arrListSanPhamAdmin.get(i).getPricegiamgia()%></td>

									<td>  
										
										<a href="http://localhost:8080/DoAnGiuaKiWeb/EditSpAdmin?id=<%=arrListSanPhamAdmin.get(i).getId()%>">Edit</a>
										<a href="http://localhost:8080/DoAnGiuaKiWeb/SanphamAdmin?id=<%=arrListSanPhamAdmin.get(i).getId()%>&index=1">Delete</a>
									</td>
							...
							<div class="custom-pagination">
								<ul class="pagination">
									<%
										int pageSpadmin = (int) request.getAttribute("pageSpadmin");
									if (pageSpadmin != 0) {
										for (int i = 1; i < pageSpadmin; i++) {
									%>
									<li class="page-item"><a class="page-link"
										href="http://localhost:8080/DoAnGiuaKiWeb/SanphamAdmin?index=<%=i%>"><%=i%></a></li>
									<%
										}
									}
									%>
