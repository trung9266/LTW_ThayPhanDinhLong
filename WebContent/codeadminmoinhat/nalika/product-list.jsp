                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <table>
                                ...
                                <c:forEach items="${arrListSanPhamAdmin}" var="sp">
                                <tr>
                                    <td>${sp.id}</td>
                                    <td><img src="img/product/160.jpg" alt="" /></td>
                                  
                                    <td>${sp.id}</td>
                                    <td>
                                        <button class="pd-setting">${sp.id}</button>
                                    </td>
                                    <td>${sp.id}</td>
                                    <td>${sp.id}</td>
                                    <td>${sp.id}</td>
                                    ...
                                    <td>${sp.id}</td>
                                    <td>
                                         <a herf="SanphamAdmin?action=Edit&id=${s.id } }"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                         <a herf="SanphamAdmin?action=Delete&id=${s.id } }"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                    </td>
                                </tr>
                            ...
                            <div class="custom-pagination">
								<ul class="pagination">
					               <c:forEach  begin="1" end="${pageSPAdmin}" var="page">      
									<li class="page-item"><a class="page-link" href="SanphamAdmin?indexpage=${page}">${page}</a></li>
