            ...
            <div class="container">
                <div class="main-blog">
                    <div class="row" style="display: block;">
                        <div class="thitruongxe1">
                            <img class="img-ttx1" src="img/banner/thitruongxe1.jpg" alt="">
                            <div class="text-div">
                                <p class="text-ttx" style="font-weight: bold; font-size: 20px;">'Ngấm đòn' COVID-19, thị trường xe máy sụt giảm mạnh</p>
                                <p class="text-ttx">16/10/2020 17:07</p><br/>
                                <p class="text-ttx">Dịch COVID-19 đã có những ảnh hưởng lớn đến thị trường xe máy Việt Nam khiến doanh số trong 9 tháng đầu năm 2020 giảm mạnh so với cùng kỳ năm ngoái.</p>
                                <br/>
                                <br/>
                                <br/>
                            </div>
                        ...
                        <div class="thitruongxe1">
                            <img class="img-ttx1" src="img/banner/thitruongxe2.jpg" alt="">
                            <div class="text-div">
                                <p class="text-ttx" style="font-weight: bold; font-size: 20px;">Xe máy Lead, Vision, Air Blade, Winner X... tiếp tục giảm xa giá đề xuất</p>
                                <p class="text-ttx">16/10/2020 12:03</p><br/>
                                <p class="text-ttx">Một số mẫu xe máy của hãng Honda vẫn đang trên đà giảm giá, có những chiếc giảm gần 5 triệu đồng so với giá đề xuất.</p>
                                <br/>
                                <br/>
                                <br/>
                                <br/>
                        ...
                        <div class="thitruongxe1">
                            <img class="img-ttx1" src="img/banner/thitruongxe3.jpg" alt="">
                            <div class="text-div">
                                <p class="text-ttx" style="font-weight: bold; font-size: 20px;">Vắng khách mua xe máy điện</p>
                                <p class="text-ttx">13/09/2020 16:13</p><br/>
                                <p class="text-ttx">Dù đang vào mùa tựu trường nhưng các cửa hàng xe máy, xe đạp điện, xe máy điện (chủ yếu phục vụ học sinh, sinh viên) tại TP HCM rất vắng khách.</p>
                                <br/>
                                <br/>
                                <br/>
                            </div>
                        ...
                        <div class="thitruongxe1">
                            <img class="img-ttx1" src="img/banner/thitruongxe4.jpg" alt="">
                            <div class="text-div">
                                <p class="text-ttx" style="font-weight: bold; font-size: 20px;">Xe máy Honda "nếm mùi" sụt giảm mạnh</p>
                                <p class="text-ttx">10/09/2020 15:20</p><br/>
                                <p class="text-ttx">Xe máy Honda gần như chiếm lĩnh thị trường. Hằng tháng hãng xe này đều có báo cáo số lượng bán ra, chỉ có tăng chứ chưa thấy giảm. Tuy nhiên, từ khi xảy ra dịch Covid-19, hãng này phải...</p>
                                <br/>
                                <br/>
                                <br/>
                            </div>
                        ...
                        <div class="thitruongxe1">
                            <img class="img-ttx1" src="img/banner/thitruongxe5.jpg" alt="">
                            <div class="text-div">
                                <p class="text-ttx" style="font-weight: bold; font-size: 20px;">Xe máy ế ẩm, giá giảm mạnh</p>
                                <p class="text-ttx">30/08/2020 10:10</p><br/>
                                <p class="text-ttx">Như mọi năm và cũng như thị trường ôtô, các đại lý xe máy trong tháng 7 âm lịch rơi vào tình trạng ế ẩm bởi nhiều người có quan niệm kiêng mua sắm trong tháng "cô hồn" này.</p>
                                <br/>
                                <br/>
                                <br/>
                            </div>
                        ...
                        <div class="thitruongxe1">
                            <img class="img-ttx1" src="img/banner/thitruongxe6.jpg" alt="">
                            <div class="text-div">
                                <p class="text-ttx" style="font-weight: bold; font-size: 20px;">Honda SH Mode 2020 về đại lý đội giá bán cả chục triệu đồng, nhiều mẫu xe khác giảm sập sàn</p>
                                <p class="text-ttx">29/07/2020 22:56</p><br/>
                                <p class="text-ttx">Để kích cầu tiêu dùng, nhiều doanh nghiệp kinh doanh xe máy đồng loạt giảm giá bán, thậm chí thấp hơn giá đề xuất của nhà sản xuất.</p>
                                <br/>
                                <br/>
                                <br/>
                                <br/>
                        ...
                        <div class="thitruongxe1">
                            <img class="img-ttx1" src="img/banner/thitruongxe7.jpg" alt="">
                            <div class="text-div">
                                <p class="text-ttx" style="font-weight: bold; font-size: 20px;">Thị trường xe máy Việt Nam sụt giảm 1/3 vì COVID-19</p>
                                <p class="text-ttx">13/07/2020 09:05</p><br/>
                                <p class="text-ttx">Thị trường xe máy Việt Nam trong quý II/2020 chỉ ghi nhận doanh số hơn 500.000 xe, sụt giảm mạnh tới hơn 30% do ảnh hưởng bởi COVID-19.</p>
                                <br/>
                                <br/>
                                <br/>
                                <br/>
                        ...
                        <div class="thitruongxe1">
                            <img class="img-ttx1" src="img/banner/thitruongxe8.jpg" alt="">
                            <div class="text-div">
                                <p class="text-ttx" style="font-weight: bold; font-size: 20px;">Các đại gia xe máy bất lực nhìn doanh số toàn cầu rơi tự do vì COVID-19</p>
                                <p class="text-ttx">17/04/2020 14:42</p><br/>
                                <p class="text-ttx">Ô tô cũng như xe máy là 2 trong số những ngành công nghiệp ảnh hưởng nặng nhất do COVID-19 vì cách ly xã hội đồng nghĩa với nhu cầu đi lại hạn chế tới mức tối thiểu.</p>
                                <br/>
                                <br/>
                                <br/>
                            </div>
