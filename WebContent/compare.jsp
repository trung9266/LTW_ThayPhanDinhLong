            ...
            <div class="container">
                <div class="breadcrumb">
                    <ul class="d-flex align-items-center">
                        ...
                        <li class="active"><a href="compare.html">So sánh sản phẩm</a></li>
                    </ul>
                </div>
            </div>
            <!-- Container End -->
                ...
                <div class="table-responsive-sm">
                    <table class="table text-center compare-content">
                        <tbody>
                                ...
                                <td class="product-description">
                                    <div class="compare-details">
                                        <div class="compare-detail-img">
                                            <a href="#"><img src="img\products/61.jpg" alt="compare-product"></a>
                                        </div>
                                        <div class="compare-detail-content">
                                            <span>WAY RSX</span>
                                            <h4><a href="product.html">Hãng Honda</a></h4>
                                        </div>
                                    </div>
                                </td>
                                <td class="product-description">
                                    <div class="compare-details">
                                        <div class="compare-detail-img">
                                            <a href="#"><img src="img\products\110.jpg" alt="compare-product"></a>
                                        </div>
                                        <span>SH 2020</span>
                                        <h4><a href="product.html">Hãng Xe SH</a></h4>
                                    </div>
                                </td>
                                <td class="product-description">
                                    <div class="compare-details">
                                        <div class="compare-detail-img">
                                            <a href="#"><img src="img\products\85.jpg" alt="compare-product"></a>
                                        </div>
                                        <span>Vespa Paccific</span>
                                        <h4><a href="product.html">Hãng Xe Vespa</a></h4>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="product-description">
                                    <p>Mẫu xe được ưa thích những đời đầu và bây giờ cũng được yêu mến không kém cạnh bởi vì giá thành rẻ và độ bền cao</p>
                                </td>
                                <td class="product-description">
                                    <p>SH 2020 đời mới nhất là mẫu xe sắp khuấy động thị trường xe Việt Nam ! Không thể nói rằng đây là mẫu xe bán chạy nhất ở Hcm . Với động cơ mạnh mẽ với Sức mạnh động cơ Catrol Powone mạnh mẽ</p>
                                </td>
                                <td class="product-description">
                                    <p>Vespa Mẫu xe vô cùng được ưa thích bởi các chị em phụ nữ ~ Với dáng vẻ thanh lịch quí phải và những ưu đãi vô cùng hấp dẫn đã khiến nó được mẫu xe hot nhất tháng 10,11,12 ...</p>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="product-title">Tình trạng</td>
                                <td class="product-description">Còn hàng</td>
                                <td class="product-description">Hết hàng</td>
                                <td class="product-description">Còn hàng</td>
                            </tr>
                            <tr>
                                <td class="product-title">Thêm vào giỏ hàng</td>
                                <td class="product-description">
                                    <a class="compare-cart text-uppercase" href="cart.html"> + Thêm vào giỏ hàng</a>
                                </td>
                                <td class="product-description">
                                    <a class="compare-cart text-uppercase" href="cart.html"> + Thêm vào giỏ hàng</a>
                                </td>
