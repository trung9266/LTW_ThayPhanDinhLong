       ...
       <!-- Newsletter Popup Start -->
            ...
            <div class="container">
                <div class="breadcrumb">
                    <ul class="d-flex align-items-center">
                        ...
                        <li class="active"><a href="blog">Phí lăn bánh</a></li>
                    </ul>
                </div>
            </div>
            <!-- Container End -->
        ...
        <div class="blog ptb-100  ptb-sm-60">
            <div class="container">
                <div class="main-blog">
                    <div class="row">
                        <h1>Cách tính giá lăn bánh xe máy mới tại Việt Nam năm 2020</h1>
                        <h2>Phí trước bạ xe máy</h2>
                        <p class="text-p">Sau khi người dùng mua xe máy mới, việc đầu tiên cần phải làm là đóng phí trước bạ xe máy tại các chi cục thuế, tùy theo hộ khẩu giá tính phí trước bạ xe máy ở các tỉnh thành là khác nhau.</p>
                        <p class="text-p">- Tại các thành phố trực thuộc trung ương hoặc thành phố thuộc tỉnh, thị xã nơi UBND tỉnh đóng trụ sở mức phí trước bạ dành cho xe máy là 5% trên khung giá của cơ quan thuế.</p>
                        <p class="text-p">- Các khu vực còn lại mức phí trước bạ cho xe máy là 2% trên khung giá của cơ quan thuế.</p>
                        <p class="text-p">Nhiều trường hợp giá xe máy bán ra thấp hơn thì người mua vẫn đóng phí theo khung giá của cơ quan thuế. Giá tính lệ phí trước bạ là giá do Ủy ban nhân dân tỉnh, thành phố trực thuộc Trung ương ban hành, theo quy định cụ thể của Bộ Tài chính.</p>
                        <h2>Phí cấp biển số xe máy</h2>
                        <p class="text-p">Phí cấp biển số xe máy tại các trụ sở công an có thẩm quyền. Mức phí này được tính theo giá trị xe máy và cũng phân theo tỉnh thành phố. </p>
                        <p class="text-p">- Tại Hà Nội và TP HCM, nếu xe máy có trị giá dưới 15 triệu đồng thì phí là 500.000 – 1.000.000 đồng; xe từ 15-40 triệu phí là 1 - 2 triệu; xe trên 40 triệu phí là 2 - 4 triệu đồng.</p>
                        <p class="text-p"> Còn tại các tỉnh khác mức phí sẽ dao động 50.000 - 800.000 đồng.</p>
                        <h2>Bảo hiểm trách nhiệm dân sự bắt buộc cho xe máy</h2>
                        <p class="text-p">Các loại xe máy khi tham gia giao thông phải mua bảo hiểm trách nhiệm dân sự bắt buộc cho xe máy và có thể chọn 3 mức như sau:</p>
                        <p class="text-p">- Bảo hiểm trách nhiệm dân sự: 66.000 đồng/1 năm;</p>
                        <p class="text-p">- Bảo hiểm trách nhiệm dân sự + Bảo hiểm tai nạn cho 2 người ngồi trên xe (mức 10 triệu /người): 86.000 đồng/1 năm;</p>
                        <p class="text-p">- Bảo hiểm trách nhiệm dân sự + Bảo hiểm tai nạn cho 2 người ngồi trên xe (mức 20 triệu /người): 106.000 đồng/1 năm.</p>
