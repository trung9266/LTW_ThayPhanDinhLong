            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="register-title">
                            <h3 class="mb-10">Thông tin tài khoản</h3>
                        </div>
                    </div>
                </div>
                <!-- Row End -->
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <form class="form-register" action="http://localhost:8080/DoAnGiuaKiWeb/InformationUser" method="post">
                            <fieldset>
                              ...
                              %> 
                                ...
                                <div class="form-group d-md-flex align-items-md-center">
                                    <label class="control-label col-md-2" for="l-name"><span class="require">*</span>Địa Chỉ Hoặc Tỉnh/thành phố</label>
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" id="l-name" name="diachi" placeholder="<%=user.getAddress()%>">
                                    </div>
                                </div>
                                <div class="form-group d-md-flex align-items-md-center">
                                    <label class="control-label col-md-2" for="number"><span class="require">*</span>Giới Tính</label>
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" name="gioitinh" placeholder="<%=user.getGioitinh()%>">
                                    </div>
                                </div>
                                 <div class="form-group d-md-flex align-items-md-center">
                                    <label class="control-label col-md-2" for="number"><span class="require">*</span>Passwords</label>
                                    <div class="col-md-10">
                                        <input type="password" class="form-control" id="number" name="password" placeholder="<%=user.getPassword()%>">
                                    </div>
                                </div>
                                
                                <div class="form-group d-md-flex align-items-md-center">
                                    <label class="control-label col-md-2" for="number"><span class="require">*</span>Khác</label>
                                    <div class="col-md-10">
                                        <textarea rows="9" cols="70" style="width: 100%;">
                                          </textarea>  
                                    </div>
                                </div>
                            </fieldset>
                            ...
                            <div class="terms">
                                <div class="float-md-right">
                                    <input type="submit" value="Lưu" class="return-customer-btn">
                                </div>
                            </div>
                        </form>
